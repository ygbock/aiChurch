                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-4 mt-1">
                        ...
                        <div className="flex items-center gap-1.5 text-slate-400">
                          <Calendar size={12} />
                          <span className="text-[10px] font-bold uppercase">Visited: {safeFormat(visitor.firstVisit || Date.now(), 'MMM d, yyyy')}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                   ...
                   logs.map(log => (
                      <div key={log.id} className="bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                         <div className="flex justify-between items-start mb-2">
                            ...
                            <span className="text-[9px] font-bold text-slate-400">{log.date ? safeFormat(log.date, 'MMM d, h:mm a') : 'Now'}</span>
                         </div>

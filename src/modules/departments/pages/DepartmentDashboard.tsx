...
export default function DepartmentDashboard() {
  ...
  useEffect(() => {
    ...
    if (!isSuperAdmin && (!profile?.districtId || !profile?.branchId)) return;
    ...
    const fetchDeptAndMembers = async () => {
      try {
        ...
        setMembers(memberSnap.docs.map(doc => ({ id: doc.id, ...(doc.data() as any) })));
    ...
    fetchDeptAndMembers();
  }, [departmentId, profile, isSuperAdmin]);
